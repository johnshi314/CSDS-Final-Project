...
// NOTE: This script was commented out by John Shi due to the creation of AbstractAgent.cs, which
// defines overall behavior for all agents. This was done so that all future agents can have their
// own unique scripts that inhereit from AbstractAgent to avoid having just one large script for all behavior.
